...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden md:block text-sidebar-foreground fixed inset-y-0 h-svh z-30"
        data-state={state}
      ...
      >
        <div
          className={cn(
            "duration-200 h-svh w-[--sidebar-width] bg-sidebar transition-[width] ease-in-out border-r border-sidebar-border",
